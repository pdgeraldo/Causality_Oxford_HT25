...
Imagine if we want to test the hypothesis: [Does attending this lecture improves your productivity in the long-term?]()

* Can we directly compare the ones who attended to the ones who didn't attend?

* Can we randomise who *actually* attended the lecture?

* Can we randomise *invitations* to the lecture, or reminders?

* Can we construct a variable that predicts who attended, independent of potential productivity? 

## Intuition for IV

If we could actually randomise the reminders, then we would have an experiment!

But remember, we want the effect of *attending* the lecture, not the effect of *being registered* in the class!

$$
ATE_{\text{lecture}} = E[P_a - P_{\bar{a}}]
$$
$$
...
* i.e., that receiving a reminder to attend the lecture only affects people's productivity through the lecture itself
...
To re-scale the ITT, we need to estimate the probability of switching the attendance to the lecture due to the reminder --> Randomisation!
...
*  **Defiers**: those who were planned to attend, but when reminded (and after re-reading the lecture topics), they would rather not! *We assume that this group does not exist*
...
* The instrument $Z$ and the outcome $Y$ are $d-$separated in the interventional DAG where we $do(d)$, $G_{\overline{D}}$
